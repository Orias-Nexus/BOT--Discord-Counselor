#!/bin/bash
# L5: Chỉ sync, generate prisma và restart
KEY_HOME="/tmp"
KEY_TYPE="gcp_key"
...
echo "===================================================="
echo "L5: Starting Source Code Synchronization (Sync, Prisma & Restart)"
echo "===================================================="
...
echo "[3/4] Generating Prisma and restarting services on Server..."
